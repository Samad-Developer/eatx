      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="px-8 py-4 bg-gradient-to-r from-red-600 to-red-700 text-white font-medium rounded-lg hover:shadow-lg transition-all duration-300">
              Request a Demo
            </button>
            <button className="px-8 py-4 bg-white text-red-600 border-2 border-red-600 font-medium rounded-lg hover:bg-red-50 transition-colors">
              View More Reviews
            </button>
          </div>
        </div>
