              ...
              <div className="p-1 ">
                <div className="bg-gray-900 rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    {/* Chart placeholder */}
                    <div className="h-40 bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg border border-gray-700 p-4 flex flex-col justify-between">
                      <div className="text-gray-300 text-sm font-medium">Sales Performance</div>

                      <div className="relative flex-1 flex items-end space-x-1 mt-3">
                        {/* Simulated data using gradient "waves" */}
                        {[
                          'h-4 bg-gradient-to-t from-red-500 to-transparent',
                          'h-10 bg-gradient-to-t from-red-400 to-transparent',
                          'h-6 bg-gradient-to-t from-red-600 to-transparent',
                          'h-16 bg-gradient-to-t from-red-500 to-transparent',
                          'h-12 bg-gradient-to-t from-red-400 to-transparent',
                          'h-8 bg-gradient-to-t from-red-600 to-transparent',
                          'h-14 bg-gradient-to-t from-red-500 to-transparent'
                        ].map((barClass, i) => (
                          <div
                            key={i}
                            className={`w-full rounded-b-sm rounded-t ${barClass}`}
                      ...
                      <div className="flex justify-between text-xs text-gray-500 mt-2">
                        {['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'].map((label, i) => (
                          <div key={i} className="text-center w-full">{label}</div>
                        ))}
                      </div>
                    </div>
